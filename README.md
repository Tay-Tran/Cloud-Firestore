...
Project này chủ yếu là để biết cách sử dụng: 
1.Các API thao tác với dữ liệu: đọc, thêm, xóa, lắng nghe sự thay đổi của dữ liệu, do Cloud Firestore cung cấp. 
2. Biết cách sử dụng Cloud Firestore cho ứng dụng Website.
3.Biết cách đưa Website lên Hosting của Firebase. 
